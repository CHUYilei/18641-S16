...
public class DefaultSocketServer extends Thread implements SocketServerInterface, SocketServerConstant {
    ...
    public void handleSession() {
        ...
        while(true) {
            ...
            System.out.println("[INFO] Server receives opcode "+opcode);
            ...
            } else if (opcode.equals(this.GETLIST_OPCODE)){
            	handleGetListRequest();
            } else if (opcode.equals(this.GETAUTO_OPCODE)){
            	handleGetAutoRequest();
        	}else {
    ...
    /**
     * For servlet
     * return the list of automobiles
     */
    public void handleGetListRequest(){
    	String message = "Server ready. Please receive automobile list";
        ...
        System.out.println("[INFO] Server sends model list with size "+autoList.size());
    }
    
    /**
     * For servlet
     * return the selected auto object by name
     */
    public void handleGetAutoRequest(){
        // receive user's choice from client
        String chosenName = (String)receiveResponse();
        ...
        // send the success message
        String message = "[INFO] Server sends chosen automobile successfully";
        sendOutput(message);
    }
