...
public class OptionSet implements Serializable {
     ...
     * @return
     */
    protected Map<String, Float> getOptionSetContentAsMap(){
    	Map<String, Float> content = new HashMap<String, Float>();
    	
    	for(Option op: this.opts){
    		content.put(op.getName(), op.getPrice());
    	}
    	
    	return content;
    }
    
    protected String getOptionName(int opId){
    	return this.opts.get(opId).getName();
    }

    protected float getOptionPrice(int opId){
    	return this.opts.get(opId).getPrice();
    }
